...
import DeepGaze.deepgaze_pytorch as deepgaze
...
deepgaze_model = deepgaze.DeepGazeIIE(pretrained=True).to(device)
unisal_model = Trainer.init_from_cfg_dir(Path('unisal/training_runs/pretrained_unisal'))
unisal_model.model.to(device)
